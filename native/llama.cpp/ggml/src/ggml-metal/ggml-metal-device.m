...
bool ggml_metal_device_supports_op(ggml_metal_device_t dev, const struct ggml_tensor * op) {
    ...
    switch (op->op) {
        ...
        case GGML_OP_OPT_STEP_SGD:
            return has_simdgroup_reduction;
        case GGML_OP_CUSTOM:
            return ggml_metal_is_btl3_avq2(op) ||
                ggml_metal_is_btl3_int4(op) ||
                ggml_metal_is_btl3_vocab_rows(op) ||
                ggml_metal_is_btl3_vocab_head(op) ||
                ggml_metal_is_btl3_packed_probe(op);
        default:
            return false;
    }
}
