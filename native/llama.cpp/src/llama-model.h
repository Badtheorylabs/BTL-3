...
struct llama_btl3_avq2_weight {
    struct ggml_tensor * codes          = nullptr;
    struct ggml_tensor * affine_weight  = nullptr;
    struct ggml_tensor * affine_bias    = nullptr;
    struct ggml_tensor * input_signs    = nullptr;
    struct ggml_tensor * output_signs   = nullptr;
    struct ggml_tensor * int4_codes     = nullptr;
    struct ggml_tensor * int4_scales    = nullptr;
    struct ggml_tensor * int4_zeros     = nullptr;
    struct ggml_tensor * lora_a         = nullptr;
    struct ggml_tensor * lora_b         = nullptr;
};

struct llama_btl3_vocabulary_weight {
    struct ggml_tensor * codes             = nullptr;
    struct ggml_tensor * affine_weight     = nullptr;
    struct ggml_tensor * affine_bias       = nullptr;
    struct ggml_tensor * input_signs       = nullptr;
    struct ggml_tensor * rescued_row_ids   = nullptr;
    struct ggml_tensor * rescued_upper_six = nullptr;
    struct ggml_tensor * rescued_scales    = nullptr;
    struct ggml_tensor * residual_left     = nullptr;
    struct ggml_tensor * residual_right    = nullptr;
};
...
struct llama_layer {
    ...
    llama_btl3_avq2_weight btl_wq;
    llama_btl3_avq2_weight btl_wk;
    llama_btl3_avq2_weight btl_wv;
    llama_btl3_avq2_weight btl_wo;
    llama_btl3_avq2_weight btl_wqkv;
    llama_btl3_avq2_weight btl_wqkv_gate;
    ...
    llama_btl3_avq2_weight btl_ffn_gate;
    llama_btl3_avq2_weight btl_ffn_down;
    llama_btl3_avq2_weight btl_ffn_up;
    ...
    llama_btl3_avq2_weight btl_ssm_out;
...
struct llama_model {
    ...
    llama_btl3_vocabulary_weight btl_tok_embd;
    llama_btl3_vocabulary_weight btl_output;
